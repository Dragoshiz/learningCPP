...
int main(int argc, char *argv[]){
	...
	std::cout << "\n";
	to_print = merge_insert_alg<std::vector<int>, std::vector<std::pair<int, int > > >(to_print, &time);
	std::cout << "After: ";
	print_container(to_print);
	std::cout << "\n";
	...
	d_deque = merge_insert_alg<std::deque<int>, std::deque<std::pair<int, int > > >(d_deque, &time);
	...
	d_vectr = merge_insert_alg<std::vector<int>, std::vector<std::pair<int, int > > >(d_vectr, &time);
